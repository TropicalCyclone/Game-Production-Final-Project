...
{
    // I am having trouble with the placard socket in the placard puzzle with the use of prefab
    // that's why I am utilizing position shuffling of existing game object instead of spawning it with prefab
    // If there's a better alternative, kindly replace this.
